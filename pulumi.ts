...
const functionGenerate = new gcp.cloudfunctions.HttpCallbackFunction(
  "generate",
  {
    ...
    environmentVariables: {
      GRAPHQL_ENDPOINT: "https://api.studio.thegraph.com/query/28103/cooler-loans-goerli/0.0.4",
    },
  },
  {
 ...
 */
const corsOrigins = ["https://app.olympusdao.finance/", "https://staging.olympusdao.finance", "https://*.fleek.co"];
