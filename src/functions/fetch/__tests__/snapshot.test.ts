...
describe("generateSnapshots", () => {
  ...
  it("should generate a snapshot for each day in the date range", () => {
    ...
    expect(snapshotOne.loans[0].id).toBe(0);
    expect(snapshotOne.loans[0].createdTimestamp).toBe(1690876800);
    expect(snapshotOne.loans[0].borrower).toBe("0x01");
    expect(snapshotOne.loans[0].lender).toBe("0x02");
    ...
    for (let i = 1; i < 9; i++) {
      ...
      expect(currentSnapshot.loans[0].id).toBe(snapshotOne.loans[0].id);
      expect(currentSnapshot.loans[0].createdTimestamp).toBe(snapshotOne.loans[0].createdTimestamp);
      expect(currentSnapshot.loans[0].borrower).toBe(snapshotOne.loans[0].borrower);
      expect(currentSnapshot.loans[0].lender).toBe(snapshotOne.loans[0].lender);
    ...
    expect(snapshotTen.loans[0].id).toBe(0);
    ...
    for (let i = 10; i < 19; i++) {
      ...
      expect(currentSnapshot.clearinghouse.sDaiInDaiBalance).toBe(600000.01);
      expect(currentSnapshot.loans.length).toBe(1);
      expect(currentSnapshot.loans[0].id).toBe(snapshotTen.loans[0].id);
      expect(currentSnapshot.loans[0].createdTimestamp).toBe(snapshotTen.loans[0].createdTimestamp);
      expect(currentSnapshot.loans[0].borrower).toBe(snapshotTen.loans[0].borrower);
      expect(currentSnapshot.loans[0].lender).toBe(snapshotTen.loans[0].lender);
    ...
    expect(snapshotTwenty.loans[0].id).toBe(snapshotTen.loans[0].id);
    expect(snapshotTwenty.loans[0].createdTimestamp).toBe(snapshotTen.loans[0].createdTimestamp);
    expect(snapshotTwenty.loans[0].borrower).toBe(snapshotTen.loans[0].borrower);
    expect(snapshotTwenty.loans[0].lender).toBe(snapshotTen.loans[0].lender);
  ...
  it("should use the previous day records", () => {
    ...
    expect(snapshots[0].loans[0].id).toBe(0);
    expect(snapshots[0].loans[0].createdTimestamp).toBe(1690876800);
    expect(snapshots[0].loans[0].borrower).toBe("0x01");
    expect(snapshots[0].loans[0].lender).toBe("0x02");
